...
const items = [
    ...
    { title: "Survey and Research", icon: ClipboardList },
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {items.map((item, i) => (
                        <motion.div
                            ...
                            className="group rounded-2xl border border-border bg-foreground/5 p-5 shadow-inner backdrop-blur transition-transform hover:-translate-y-1"
                        >
                ...
                <div className="mt-6 flex justify-center gap-6">
                    {platforms.map((platform, i) => (
                        <motion.div
                            ...
                            className="group flex flex-col items-center rounded-2xl border border-border bg-foreground/5 p-4 shadow-inner backdrop-blur transition-transform hover:-translate-y-1"
                        >
